...
namespace BibliothèqueSqlite.Forms
{
    public partial class FrmPublishingClassBooks : FrmMaster
    {
        ...
        public FrmPublishingClassBooks(bool isPuplishing,long id)
        {
            ...
            {
                tblPublishing = db.tblPublishing.Single(p => p.Id == id);
            }
        ...
        public override void Save()
        {
            ...
            {
                SetData();
                db.tblPublishing.AddOrUpdate(tblPublishing);
                db.SaveChanges();
            }
            base.Save();
        }
        ...
        public override void Delete()
        {
            ...
            using (var db = new DBContext())
            {
                ...
                {
                    SetData();
                    db.tblPublishing.Remove(db.tblPublishing.Single(x => x.Id == tblPublishing.Id));
                    db.SaveChanges();
